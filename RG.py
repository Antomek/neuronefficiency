...
def am_KC(V):   return KC_alpha(V, A_KC_am, B_KC_am, C_KC_am, #insert conc)
def bm_KC(V):   return KC_beta(V, A_KC_bm, B_KC_bm, C_KC_bm)
...
y_0 = [V_0, m_NaF_0, h_NaF_0, m_Kdr_0, h_Kdr_0, m_CaL_0, h_CaL_0, m_KA_0, h_KA_0, m_KC_0]
